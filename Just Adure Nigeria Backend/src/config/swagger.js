...
const requestBodies = {
    ...
    "POST /api/v1/checkout": body({ type: "object", required: ["customer", "deliveryAddress", "deliveryMethod"], properties: { customer: { type: "object" }, deliveryAddress: { type: "object" }, deliveryMethod: { type: "string" }, notes: { type: "string" } } }, { customer: { name: "Demo Customer", email: "customer@gmail.com", phone: "08000000002" }, deliveryAddress: { addressLine1: "12 Allen Avenue", state: "Lagos", city: "Ikeja" }, deliveryMethod: "delivery" }),
